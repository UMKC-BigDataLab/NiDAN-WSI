...
val queries = List(("SELECT imageBytes FROM data WHERE WHERE  partitionIndex = 96  OR  partitionIndex = 97 ", 2))
...
val dataSource = "/nidan/orc/individualORC/slide14"
val queries = List(("SELECT imageBytes FROM data WHERE WHERE  partitionIndex = 43  OR  partitionIndex = 57 ", 2))
...
val dataSource = "/nidan/orc/individualORC/slide3"
val queries = List(("SELECT imageBytes FROM data WHERE WHERE  partitionIndex = 129  OR  partitionIndex = 143 ", 2))
