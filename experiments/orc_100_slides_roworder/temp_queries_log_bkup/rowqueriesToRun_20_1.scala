...
val queries = List(("SELECT imageBytes FROM data WHERE WHERE  partitionIndex = 20 ", 1))
...
val dataSource = "/nidan/orc/individualORC/slide8"
val queries = List(("SELECT imageBytes FROM data WHERE WHERE  partitionIndex = 174 ", 1))
...
val queries = List(("SELECT imageBytes FROM data WHERE WHERE  partitionIndex = 176 ", 1))
