...
val dataSource = "/nidan/orc/individualORC/slide1"
val queries = List(("SELECT imageBytes FROM data WHERE WHERE  partitionIndex = 186  OR  partitionIndex = 187 ", 2))
...
val dataSource = "/nidan/orc/individualORC/slide20"
val queries = List(("SELECT imageBytes FROM data WHERE WHERE  partitionIndex = 17  OR  partitionIndex = 18 ", 2))
