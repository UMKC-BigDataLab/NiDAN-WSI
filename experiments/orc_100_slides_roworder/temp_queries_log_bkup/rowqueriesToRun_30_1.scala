...
val dataSource = "/nidan/orc/individualORC/slide29"
val queries = List(("SELECT imageBytes FROM data WHERE WHERE  partitionIndex = 188 ", 1))
...
val queries = List(("SELECT imageBytes FROM data WHERE WHERE  partitionIndex = 33 ", 1))
...
val dataSource = "/nidan/orc/individualORC/slide6"
val queries = List(("SELECT imageBytes FROM data WHERE WHERE  partitionIndex = 218 ", 1))
