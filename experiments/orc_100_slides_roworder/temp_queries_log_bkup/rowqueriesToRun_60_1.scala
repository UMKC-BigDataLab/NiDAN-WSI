...
val queries = List(("SELECT imageBytes FROM data WHERE WHERE  partitionIndex = 228 ", 1))
...
val queries = List(("SELECT imageBytes FROM data WHERE WHERE  partitionIndex = 178 ", 1))
...
val dataSource = "/nidan/orc/individualORC/slide24"
val queries = List(("SELECT imageBytes FROM data WHERE WHERE  partitionIndex = 198 ", 1))
...
val dataSource = "/nidan/orc/individualORC/slide50"
val queries = List(("SELECT imageBytes FROM data WHERE WHERE  partitionIndex = 68 ", 1))
...
val dataSource = "/nidan/orc/individualORC/slide24"
val queries = List(("SELECT imageBytes FROM data WHERE WHERE  partitionIndex = 92 ", 1))
