...
# query-generator.py NUM_QUERIES MAX_PARTITIONS NUM_TILES NUM_SLIDES OUTPUT_FILE
...
NUM_SLIDES = int(sys.argv[4])
OUTPUT_FILE = sys.argv[5]

dataSource = []
for x in range(NUM_QUERIES):
    dataSource.append("val dataSource = \"/nidan/orc/individualORC/slide"+str(random.randint(1,NUM_SLIDES)) + "\"")
