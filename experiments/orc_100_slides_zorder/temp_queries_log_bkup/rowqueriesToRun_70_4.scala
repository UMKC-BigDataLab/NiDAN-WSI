...
val queries = List(("SELECT imageBytes FROM data WHERE WHERE  partitionIndex = 91  OR  partitionIndex = 105  OR  partitionIndex = 106  OR  partitionIndex = 92 ", 4))
...
val queries = List(("SELECT imageBytes FROM data WHERE WHERE  partitionIndex = 195  OR  partitionIndex = 196  OR  partitionIndex = 182  OR  partitionIndex = 183 ", 4))
