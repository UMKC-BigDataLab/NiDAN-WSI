...
val queries = List(("SELECT imageBytes FROM data WHERE WHERE  partitionIndex = 120  OR  partitionIndex = 121 ", 2))
...
val queries = List(("SELECT imageBytes FROM data WHERE WHERE  partitionIndex = 126  OR  partitionIndex = 127 ", 2))
...
val dataSource = "/nidan/orc/individualORC/slide36"
val queries = List(("SELECT imageBytes FROM data WHERE WHERE  partitionIndex = 128  OR  partitionIndex = 129 ", 2))
